            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-5">
                    ...
                    <div class="payment-logos">
                        ...
                        <img src="{{ asset('frontAsset/images/icons/payment/american-express.png') }}" alt="american-express">
                        <img src="{{ asset('frontAsset/images/icons/payment/mastercard.png') }}" alt="mastercard">
                        <img src="{{ asset('frontAsset/images/icons/payment/visa.png') }}" alt="visa">
                        <img src="{{ asset('frontAsset/images/icons/payment/paypal.png') }}" alt="paypal">
                        <img class="last" src="{{ asset('frontAsset/images/icons/payment/maestro.png') }}" alt="maestro">
                    </div>
