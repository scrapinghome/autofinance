...
@section('frontContent')
    ...
    @include('front.layout.banner', ['text' => 'Checkout', 'pageName' => 'Checkout', 'image' => 'frontAsset/images/backgrounds/bg-banner.jpg'])
                    ...
                    <div class="col-sm-12 col-md-6 text-right">
                        <form class="payment text-left">
                            ...
                            <div class="cheque">
                                ...
                                <p class="text-dark">Please send us your cheque by Post to : <strong>123 Disney Street
                                        Slim Av. Brooklyn Bridge, NY, New York PO BOX 152</strong></p>
                            </div>
                            <!-- Payment Cheque Ends -->
                            ...
                            <div class="paypal">
                                ...
                                <span class="tooltip-text" data-toggle="tooltip" data-placement="top"
                                      title="PayPal is a service that enables you to pay, send money, and accept payments. Register your credit card or debit card with your PayPal account. You can pay by simply choosing PayPal at checkout">What is PayPal?</span>
                                <!-- Paypal Tooltip Ends -->
